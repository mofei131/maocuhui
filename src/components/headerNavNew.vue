<template>
  <div class="headerWrap">
      ...
      <div class="headerBox">
        ...
        <div class="logoNav">
          <div @mouseover="mouseOver('1')" @mouseleave="leave()" @click="navto('/wanghongwf')" :class="mouseOver_index == 1 ? 'select-nav' : ''">
            ...
            <div v-if="$i18n.locale === 'zh'" class="huoli">网红潍坊</div>
            <div v-if="$i18n.locale === 'en'" class="huoli">Wanghong Weifang</div>
          </div>
          <div @mouseover="mouseOver('2')" @mouseleave="leave()" :class="mouseOver_index == 2 ? 'select-nav' : ''" @click="webPage('http://ccpit.weifang.gov.cn/')" class="">
            ...
            <div v-if="$i18n.locale === 'zh'" class="huoli">活力贸促</div>
            <div v-if="$i18n.locale === 'en'" class="huoli">Dynamic promotion</div>
          </div>
          <div>
          </div>
      </div>
      <div class="logoBox" @click="stadiumId = ''">
        <router-link to="/home">
          <div class="sty-logo-title"><img style="width: 100%;" class src="../assets/images/indexpicnew/indexlogin.png" alt /></div>
        </router-link>
      </div>
        <div class="logoNav2">
          <!-- 全文搜索 -->
          ...
          <div  class="searchBox">
              <div class="search">
                <el-input placeholder="请输入关键词" v-model="searchText" class="input-with-select" @input="getValue" >
                  <el-select v-model="golbalTab"  slot="prepend" placeholder="请选择" style="color: #fff;" >
                  ...
                  <el-button  class="input-with-select" slot="append" icon="el-icon-search" @click='goTo()'></el-button>
                </el-input>
              </div>
          </div>
      </div>
...
<style lang="scss" scoped>
  ...
  .el-select>.el-input{
    color: #fff;
        background-color: rgba(3,68,236,.6);

  }
  // .el-input__icon,.el-input__suffix-inner,.el-input__suffix{
  //   color: #fff!important;
  // }
  // .el-input-group--append .el-input__inner, .el-input-group__prepend{
  //   background-color: rgba(3,68,236,0.25)!important;
  //   color: #D5E5F9!important;
  //   font-size: 15px!important;
  //   border: 0!important;
  // }
  // .el-input,.el-select,.input-with-select{
  //   background-color: rgba(3,68,236,0.25)!important;
  //   color: #D5E5F9!important;
  //   font-size: 15px!important;
  //   border: 0!important;
  ...
  .huoli{
    width: 179px;
    height: 47px;
    background-color: rgba(3,68,236,0.25);
    font-size: 16px;
