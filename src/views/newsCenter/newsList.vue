  ...
  methods: {
    ...
    getDataList() {
      if (this.type == 15) {
        this.dataList = [
          {
            title: "GIS时空大数据支持下的应急资源调配管理系统",
            content: "参赛企业:山东正元航空遥感技术有限公司",
            createdTime: "联系人：周文豪",
            refUrl:
              "https://weifang-www.obs.cn-north-4.myhuaweicloud.com/Skills/0001.pdf",
            flag: 1,
            id: 67,
            newsImgUrl: null,
          },
          {
            title: "青岛银行股份有限公司",
            content: "参赛企业:青岛银行股份有限公司",
            createdTime: "联系人：姜琦",
            refUrl:
              "https://weifang-www.obs.cn-north-4.myhuaweicloud.com/Skills/0026.pdf",
            flag: 1,
            id: 67,
            newsImgUrl: null,
          },
    ...
    titleHandle(path) {
      this.pageIndex = 1;
      if (path == "/newsCenter/exhibitionReport") {
        this.type = 1;
        this.title = this.$t("newsList.t1");
      } else if (path == "/newsCenter/PostShowReport") {
        this.type = 12;
        this.title = this.$t("newsList.t2");
      } else if (path == "/newsCenter/pressRelease-news") {
        this.type = 13;
        this.title = this.$t("newsList.t3");
      } else if (path == "/newsCenter/reprintedAndMediaReports") {
        this.type = 14;
        this.title = this.$t("newsList.t6");
      }else if (path == "/newsCenter/skillsCompetition") {
        this.type = 15;
        this.title = this.$t("newsList.t5");
      }
      this.getDataList();
    },
  },
